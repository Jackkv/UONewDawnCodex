...
Comprehensive guide to items, equipment, and gear in New Dawn.
...
Different weapon types for various combat styles:

[:octicons-arrow-right-24: Weapons Guide](weapons.md)

### Armor

Protect yourself with various armor types:

[:octicons-arrow-right-24: Armor Guide](armor.md)
