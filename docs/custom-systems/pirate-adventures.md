...
|               Deteriorating Map               |
|:---------------------------------------------:|
| ![icon](../assets/items/pirate-map-brown.png) |
...
|:------------------------------------------------:|:--------------------:|
|  ![icon](../assets/items/pirate-chest-red.png)   |   Pirate Hideaway    |
|  ![icon](../assets/items/pirate-chest-blue.png)  |  Pirate Lighthouse   |
| ![icon](../assets/items/pirate-chest-green.png)  | Pirate Treasure Cave |
| ![icon](../assets/items/pirate-chest-purple.png) |     Pirate Tomb      |
...
|                   Red Map                   |
|:-------------------------------------------:|
| ![icon](../assets/items/pirate-map-red.png) |
...
|                   Blue Map                   |
|:--------------------------------------------:|
| ![icon](../assets/items/pirate-map-blue.png) |
...
|                   Green Map                   |
|:---------------------------------------------:|
| ![icon](../assets/items/pirate-map-green.png) |
...
|                   Purple Map                    |
|:----------------------------------------------:|
| ![icon](../assets/items/pirate-map-purple.png) |
